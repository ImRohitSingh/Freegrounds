...
public class KillThemAllView extends SurfaceView implements Runnable {
    ...
    public KillThemAllView(KillThemAllGameActivity activity, int screenX, int screenY) {
        ...
        background1 = new KillThemAllBackground(screenX, screenY, getResources());
        background2 = new KillThemAllBackground(screenX, screenY, getResources());
